  ...
  en: {
    ...
    timeline: {
      ...
      items: [
        ...
        { year: '2026', month: 'May', title: 'Resilience Tested', desc: 'A major ban hit @COSV5CN. The community weathered it — backup channels activated, assets reorganized.' },
        { year: '2026', month: 'June', title: 'Rebuilding & Beyond', desc: 'Launched the COSV5 Nav station, Telegraph guide, and integrated tools. Stronger than before.' },
    ...
    password: {
      ...
      warn: 'Case Sensitive',
      history: 'History: @coserdh / 123321',
      steps_title: 'Steps',
  ...
  zh: {
    ...
    timeline: {
      ...
      items: [
        ...
        { year: '2026', month: '5月', title: '封禁考验', desc: '@COSV5CN 遭遇大规模封禁。社群扛住了——备份频道激活，资产迅速重组。' },
        { year: '2026', month: '6月', title: '重建与升级', desc: '推出 COSV5 导航站、Telegraph 指南、工具整合。比以前更强。' },
